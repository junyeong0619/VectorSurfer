"""
Overview tab component - Main dashboard metrics and charts
"""
...
from data.vectorwave_client import fetch_metrics, fetch_timeline_data, fetch_recent_errors_data
...
def render_recent_errors_table():
    """Render recent errors table"""
    st.markdown('<div class="chart-container">', unsafe_allow_html=True)
    st.markdown('<div class="chart-title">Recent Errors</div>', unsafe_allow_html=True)
    
    errors = fetch_recent_errors_data(limit=10)
